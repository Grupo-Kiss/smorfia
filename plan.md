# Plan de Desarrollo: Smorfia App
...
- [ ] Corregir bugs y ajustar el diseño.
- [ ] (Opcional) Escribir pruebas unitarias para la lógica de búsqueda.

## Fase 6: Preparación para Publicación
- [ ] Generar los íconos y splash screen de la aplicación.
- [ ] Configurar el `build.gradle` para la firma de la app.
- [ ] Generar el archivo AAB (Android App Bundle) para subir a la Play Store.
- [ ] Preparar los textos y capturas de pantalla para la ficha de la tienda.
